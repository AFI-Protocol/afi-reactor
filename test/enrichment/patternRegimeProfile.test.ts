...
describe("Pattern Regime Profile", () => {
  ...
  it("should detect late_bull / top_risk regime", async () => {
  ...
  it("should return null when OHLC data is insufficient", async () => {
  ...
  it("should work with only OHLC data (no Fear & Greed)", async () => {
