 ...
 * 
 * Tests for deterministic novelty scoring with replay-canonical guarantees.
 * 
 * Test Coverage:
...
let testCollection: Collection<TssdSignalDocument> | null = null;
...
beforeAll(async () => {
  ...
  try {
    ...
    testCollection = testDb.collection<TssdSignalDocument>(TEST_COLLECTION_NAME);
...
describe("Novelty Scoring (Phase: Real Novelty + Replay Canonical)", () => {
